...
/**
 * This class is used to get the all Table information from any DataBase i.e.
 * independent on DataBase vendor.
 * 
...
public class DataBaseMetaData {
	...
	/**
	 * This Method returns the List of DataBase name.
	 * 
	 * @exception DataAccessException.
	 * 
	 * @return List<String> i.e. DataBase Name.
	 */
