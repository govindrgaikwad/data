...
public class MainGenerator {
	...
	public void generate() {
		try {
			...
			generateService(tables, basePath);
			generateWebService(tables, basePath);
			generateWebServiceImpl(tables, basePath);
		} catch (DataAccessException e) {
			e.printStackTrace();
	...
	@Transactional
	public void generateService(List<Table> tables, String path)
			throws FileWriteException {
		Properties p = new Properties();
		p.setProperty("resource.loader", "class");
		p.setProperty("class.resource.loader.class",
		...
		context.put("StringUtil", new StringUtils());
		for (Table table : tables) {
			File file = new File("src/generated/com/tmg/generator/services/");
			if (!file.exists())
				file.mkdirs();
			context.put("Table", table);
			FileWriter w;
			try {
				w = new FileWriter("src/generated/com/tmg/generator/services/"
	...
	@Transactional
	public void generateWebService(List<Table> tables, String path)
			throws FileWriteException {
		Properties p = new Properties();
		p.setProperty("resource.loader", "class");
		p.setProperty("class.resource.loader.class",
		...
		context.put("StringUtil", new StringUtils());
		for (Table table : tables) {
			File file = new File("src/generated/com/tmg/generator/webservices/");
			if (!file.exists())
				file.mkdirs();
			context.put("Table", table);
			FileWriter w;
			try {
				w = new FileWriter("src/generated/com/tmg/generator/webservices/"
						+ table.getName() + "WebService.java");
				template.merge(context, w);
				w.close();
	...
	@Transactional
	public void generateWebServiceImpl(List<Table> tables, String path)
			throws FileWriteException {
		Properties p = new Properties();
		p.setProperty("resource.loader", "class");
		p.setProperty("class.resource.loader.class",
		...
		Velocity.init(p);
		VelocityContext context = new VelocityContext();
		Template template = Velocity.getTemplate("/templates/WebServiceImpl.vm");
		context.put("Tables", tables);
		context.put("StringUtil", new StringUtils());
		for (Table table : tables) {
			File file = new File("src/generated/com/tmg/generator/webservices/");
			...
			try {
				w = new FileWriter("src/generated/com/tmg/generator/webservices/"
						+ table.getName() + "WebServiceImpl.java");
				template.merge(context, w);
				w.close();
